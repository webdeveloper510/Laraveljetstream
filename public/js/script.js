...
function subscribe(channel_id, flag) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            let total_count =
                flag == 1
                    ? parseInt(subs_count) + parseInt(add)
                    : parseInt(subs_count) - parseInt(add);
...
$("#comment").submit(function (e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var body = $("#body").val();
            $(".comments").append(
                "<div><div class='row mt-3'><div class='col-2 text-end'><div class='profile-image'><a href='http://localhost/jetstream/channel/MQ=='><img src='https://spaces3.nyc3.digitaloceanspaces.com/" +
                    auth_image +
                    "' width='40px'></a></div></div><div class='col-md-10'><p class='m-0'>" +
                    "<b class='nam'>" +
                    auth_name +
                    "</b><p>" +
                    currentTime +
                    "</p></p><p class='parag'>" +
                    body +
                    "</p><div class='comment_reply_1'><div class='reply' style='color: black'></div></div><div class='d-flex'>" +
...
$(".save_reply").submit(function (e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(".comment_reply_" + data_id_value).append(
            ...
            xhr.upload.addEventListener(
                ...
                function (element) {
                    if (element.lengthComputable) {
                        var percentComplete =
                            (element.loaded / element.total) * 10;
