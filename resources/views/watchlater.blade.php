    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-3 border-end">
                ...
                <!-- <video height="100" width="100%" id="example1" poster="{{'https://spaces3.nyc3.digitaloceanspaces.com/'.$product[0]['thumbnail']}}">
                                    <source src="{{'https://spaces3.nyc3.digitaloceanspaces.com/'.$product[0]['file']}}" type="video/mp4">
               ...
               <button class="btn btn-secondary d-flex" disabled type="button"><span class="material-symbols-outlined">
                ...
                <p class="mt-3"><span class="material-symbols-outlined">
                    sync_disabled
                        ...
                        <hr/>
                        <div class="d-flex">
                        <img src="{{'https://spaces3.nyc3.digitaloceanspaces.com/' . $product[0]['thumbnail']}}" class="rounded-circle" width="60px" height="60px"/>
                          <h4 class="mt-3 ms-3">{{Auth::user()->name;}}</h4>
                        </div>
