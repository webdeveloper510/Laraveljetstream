                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-check my-1.5">
                                                                <input class="form-check-input"
                                                                    value="Spam or misleading" type="radio"
                                                                    name="report_desc" id="flexRadioDefault7">
                                                                <label class="form-check-label ml-2"
                                    ...
                                    <div class="col-md-11">
                                        ...
                                        <div class="d-flex my-2">
                                            ...
                                            <p class="d-flex me-3"> <span class="material-symbols-outlined">
                                                ...
                                                <a  class="me-3 text-decoration-none" onclick="reply(this)">REPLY</a>                                        </div>
                                        <div class="row"  id="replyBox"  style="display: none">
                                            ...
                                            <form method="post" action="{{ route('reply.add') }}">
                                                <input type="text"  hidden class="form-control" id="exampleFormControlInput1"
               ...
               <div class="commentss">
                <div class="row mt-3">
                  <div class="col-1 text-end">
                    ...
                    <div class="col-md-11">
                        <p class="mb-2"> <b> {{$username}} </b>{{\Carbon\Carbon::parse($videos['created_at'])->diffForHumans()}}</p>
                        ...
                        <div class="row">
                          <div class="col-1 text-end">
                            <div class="profile-image mt-2">
                              <img src="<?php echo URL::to('/');?>/public/asstes/hq720.webp" height="50px" width="50px" />
                            </div>
                          </div>
                            <div class="col-md-11 mt-3">
                              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Add a comment">
