      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav navbar-nav-scroll mx-auto">
            <!-- Nav item 1 Demos -->
            <li class="nav-item">
              <a class="nav-link active" href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/event-details-2.html">Overview</a>
            </li>
            <!-- Nav item 1 Demos -->
            <li class="nav-item">
              <a class="nav-link" href="/file:///C:/Users/Hp/Downloads/Farnando/index-video.html/subscriptions">Subscriptions</a>
            </li>
            <!-- Nav item 1 Demos -->
            <li class="nav-item">
              <a class="nav-link" href="/file:///C:/Users/Hp/Downloads/Farnando/index-video.html/streams">Streams</a>
            </li>
            <!-- Nav item 1 Demos -->
            <li class="nav-item">
              <a class="nav-link" href="/file:///C:/Users/Hp/Downloads/Farnando/index-video.html/library">Library</a>
            </li>
            <!-- Nav item 2 Pages -->
          </ul>
        </div>
        ...
        <div class="row g-3 mb-4">
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              ...
              <div class="card-image">
                <img class="card-img-top" src="assets/images/post/16by9/large/01.jpg" alt="">
                <!-- Play icon -->
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="assets/images/post/16by9/large/02.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="assets/images/post/16by9/large/03.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="assets/images/post/16by9/large/04.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="assets/images/post/16by9/large/05.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
