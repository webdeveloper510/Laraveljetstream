    ...
    <div class="navbar navbar-vertical navbar-light">
        ...
        <div class="offcanvas-body pt-5 pt-lg-0">
          <!-- Card START -->
            ...
            <div class="avatar avatar-lg mb-3">
              <a href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/my-profile-about.html"><img class="avatar-img rounded-circle border border-white border-3" src="assets/images/avatar/07.jpg" alt=""></a>
            </div>
            <!-- Info -->
            <h5 class="mb-0"> <a href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/my-profile-about.html">Sam Lanson </a> </h5>
            ...
            <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/my-profile-about.html"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/home-outline-filled.svg" alt=""><span>Home </span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/Farnando/index-video.html/Popular"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/medal-outline-filled.svg" alt=""><span>Uploade Vedio </span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/Farnando/index-video.html/Recent"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/clock-outline-filled.svg" alt=""><span>Your Channel </span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/Farnando/index-video.html/Subscriptions"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/like-outline-filled.svg" alt=""><span>Save Vedio </span></a>
              </li>
              <!-- <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/Farnando/index-video.html/My favorites"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/star-outline-filled.svg" alt=""><span>My favorites </span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/Farnando/index-video.html/Wishlist"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/task-done-outline-filled.svg" alt=""><span>Wishlist </span></a>
              </li> -->
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/notifications.html"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/notification-outlined-filled.svg" alt=""><span>Notifications </span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/settings.html"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/cog-outline-filled.svg" alt=""><span>Settings </span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="file:///C:/Users/Hp/Downloads/social_v1.0.0/social_v1.0.0/template/sign-in-advance.html "> <img class="me-2 h-20px fa-fw" src="assets/images/icon/arrow-boxed-outline-filled.svg" alt=""><span>Logout </span></a>
              </li>
            </ul>
            <!-- Side Nav END -->
          </div>
      ...
      <div class="page-content">
        <div class="row mb-4">
          <div class="col-12">
            <!-- Video main feed -->
            <div class="rounded py-4 py-sm-5 overflow-hidden position-relative" style="background-image:url(assets/images/post/16by9/big/02.jpg); background-position: center center; background-size: cover; background-repeat: no-repeat;">
              ...
              <div class="p-4 p-sm-5 position-relative">
                <div class="d-flex align-items-center mb-3">
                  ...
                  <!-- Avatar name -->
                  <h6 class="mb-0"> <a class="text-white" href="#!"> Frances Guerrero </a> </h6>
                ...
                <a class="btn btn-primary stretched-link" href="new_video-details.html"> <i class="bi bi-file-earmark-play pe-1"></i>Watch now</a>
              </div>
            </div>
            <!-- Video main END -->
          </div>
        ...
        <div class="row g-3 mb-4">
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              ...
              <div class="card-image">
                <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/01.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
                <!-- Duration -->
              ...
              <div class="card-body">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> Should you become a web designer in 2022? </a> </h6>
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              ...
              <div class="card-body position-relative">
                <h6> <a class="stretched-link" href="video-details.html"> Learn web development as an absolute beginner </a> </h6>
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
                  ...
                  <!-- Avatar name -->
                  <div>
                    <h6 class="mb-0 lh-1"> <a href="#!"> Lori Ferguson <i class="bi bi-patch-check-fill text-success small"></i> </a> </h6>
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/02.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
              ...
              <div class="card-body">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> Python tutorial - Python for beginners [full course] </a> </h6>
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/03.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
              ...
              <div class="card-body">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> One of the greatest speeches ever | Steve Jobs </a> </h6>
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/04.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
              ...
              <div class="card-body">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> A trading platform - an easy start in trading </a> </h6>
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
          ...
          <div class="col-sm-6 col-md-4 col-xl-3 col-xxl-2">
            ...
            <div class="card position-relative h-100">
              <!-- Video image -->
              <div class="card-image">
                <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/05.jpg" alt="">
                <!-- Play icon -->
                <div class="card-element-hover position-absolute top-50 start-50 translate-middle">
                  <a class="icon-md bg-mode text-secondary rounded-circle" href="video-details.html"> <i class="bi bi-play-fill fs-5"> </i> </a>
                </div>
              ...
              <div class="card-body">
                ...
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
                    <img class="avatar-img rounded-circle" src="<?php echo URL::to('/'); ?>/public/assets/images/avatar/07.jpg" alt="">
                  </div>
                  <!-- Avatar name -->
                  <div>
        ...
        <div class="row g-3 mb-4">
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="card position-relative h-100">
              ...
              <div class="card-image">
                <div class="overflow-hidden fullscreen-video w-100">
                  ...
                  <div class="player-wrapper card-img-top overflow-hidden">
                    <video class="player-html" controls crossorigin="anonymous" poster="<?php echo URL::to('/'); ?>/public/assets/images/videos/poster.jpg">
              ...
              <div class="card-body position-relative">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> New movie trailers (2021 - 2022) September </a> </h6>
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
                    <img class="avatar-img rounded-circle" src="<?php echo URL::to('/'); ?>/public/assets/images/avatar/01.jpg" alt="">
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="card h-100">
              ...
              <div class="card-body position-relative">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> 15 useful apps for android smartphones users </a> </h6>
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="card position-relative h-100">
              ...
              <div class="card-body position-relative">
                <!-- Video title  -->
                <h6> <a class="stretched-link" href="video-details.html"> The Red notice | Official teaser | Netflix </a> </h6>
                <div class="d-flex mt-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xxs me-2">
                    <img class="avatar-img rounded-circle" src="<?php echo URL::to('/'); ?>/public/assets/images/avatar/03.jpg" alt="">
        ...
        <div class="tiny-slider arrow-hover overflow-hidden">
          <div class="tiny-slider-inner d-flex" data-arrow="true" data-dots="true" data-loop="true" data-autoplay="false" data-items-xxl="6" data-items-xl="5" data-items-lg="4" data-items-md="4" data-items-sm="3" data-items-xs="1" data-gutter="12" data-edge="0">
              <div>
                <!-- Video START -->
                <div class="card position-relative h-100">
                  <!-- Video image -->
                  <div class="card-image">
                    <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/06.jpg" alt="">
                    <!-- Play icon -->
              ...
              <div>
                ...
                <div class="card position-relative h-100">
                  ...
                  <div class="card-image">
                    <div class="ratio ratio-16x9 card-img-top overflow-hidden">
                      <iframe src="https://player.vimeo.com/video/169562083?h=5785cc7ede" title="Vimeo video" allowfullscreen></iframe>
                    </div>
                  </div>
                  <!-- Video info -->
                  <div class="card-body position-relative">
              ...
              <div>
                ...
                <div class="card position-relative h-100">
                  <!-- Video image -->
                  <div class="card-image">
                    <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/09.jpg" alt="">
                    <!-- Play icon -->
                    <div class="position-absolute top-50 start-50 translate-middle">
                      <a class="icon-md bg-danger text-white rounded-circle" href="#"> <i class="bi bi-play-fill fs-5"> </i> </a>
                    </div>
              ...
              <div>
                ...
                <div class="card position-relative h-100">
                  <!-- Video image -->
                  <div class="card-image">
                    <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/10.jpg" alt="">
                    <!-- Play icon -->
                    <div class="position-absolute top-50 start-50 translate-middle">
                      <a class="icon-md bg-danger text-white rounded-circle" href="#"> <i class="bi bi-play-fill fs-5"> </i> </a>
                    </div>
              ...
              <div>
                ...
                <div class="card position-relative h-100">
                  <!-- Video image -->
                  <div class="card-image">
                    <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/07.jpg" alt="">
                    <!-- Play icon -->
                    <div class="position-absolute top-50 start-50 translate-middle">
                      <a class="icon-md bg-danger text-white rounded-circle" href="#"> <i class="bi bi-play-fill fs-5"> </i> </a>
                    </div>
              ...
              <div>
                ...
                <div class="card position-relative h-100">
                  <!-- Video image -->
                  <div class="card-image">
                    <img class="card-img-top" src="<?php echo URL::to('/'); ?>/public/assets/images/post/16by9/large/08.jpg" alt="">
                    <!-- Play icon -->
                    <div class="position-absolute top-50 start-50 translate-middle">
                      <a class="icon-md bg-danger text-white rounded-circle" href="#"> <i class="bi bi-play-fill fs-5"> </i> </a>
                    </div>
