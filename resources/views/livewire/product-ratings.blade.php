                                ...
                                <form  method="POST" action="{{ url('/rate') }}">
                                    <div class="block max-w-3xl px-1 py-2 mx-auto">
                                        <div class="flex space-x-1 rating">
                                            <label for="star1">
                                                <input hidden wire:model.lazy="rating"   id="star1" name="rating" value="1" />
                                            ...
                                            <label for="star2">
                                                <input hidden wire:model.lazy="rating" type="radio" id="star2" name="rating" value="2" />
                                            ...
                                            <label for="star3">
                                                <input hidden wire:model.lazy="rating" type="radio" id="star3" name="rating" value="3" />
                                            ...
                                            <label for="star4">
                                                <input hidden wire:model.lazy="rating" type="radio" id="star4" name="rating" value="4" />
                                            ...
                                            <label for="star5">
                                                <input hidden wire:model.lazy="rating" type="radio" id="star5" name="rating" value="5" />
